...
export function TeamSection() {
  ...
  const team = teamData.map((member) => ({
    ...
    description:
      locale === "fr" ? member.description_fr : member.description_en,
    image: member.image,
  }));
  ...
  return (
    <section
      id="equipe"
      className="pt-6 md:pt-8 lg:pt-11 pb-8 md:pb-12 lg:pb-16 bg-white"
    >
      <div className="container-wrapper max-w-[1728px]">
        ...
        <div
          ...
          onScroll={(e) => {
            ...
            if (idx !== activeIndex)
              setActiveIndex(Math.max(0, Math.min(idx, team.length - 1)));
          }}
        >
          {team.map((m, idx) => (
            <article
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(0,0,0,0) 40%, rgba(36,55,104,0.85) 100%)",
                }}
              />
              ...
              <header
                ...
                style={{ width: "90%", top: "73%", left: "7.5%" }}
              >
              ...
              <div
                className="absolute transition-opacity duration-200 group-hover:opacity-0"
                style={{ width: "85%", top: "82%", left: "7.5%" }}
              >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    height: "90%",
                    background:
                      "linear-gradient(180deg, rgba(36,55,104,0) 0%, rgba(36,55,104,0.85) 65%, rgba(36,55,104,0.95) 100%)",
                  }}
                />
                {/* Nom */}
                <header
